...
<body>
	<header>
		<nav class="navbar navbar-expand-md navbar-light navbar-white">
			<div class="container">
				<a href="http://localhost:8088/BootstrapTest/test.jsp" class="navbar-brand"> <img
				...
				<div class="collapse navbar-collapse order-3" id="navbarCollapse">
					<!-- Left navbar links -->
					<ul class="navbar-nav">
						<li class="nav-item"><a href="http://localhost:8088/BootstrapTest/test.jsp" class="nav-link">Home</a>
						</li>
