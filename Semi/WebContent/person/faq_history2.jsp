        ...
        <div class="container2">
            <aside id="aside" class="aside">
                ...
                <ul style="width:230px;">
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/faqinfo.com"><i class="fa-solid fa-chalkboard-user"></i>&nbsp;&nbsp;문의내역</a></li>
            ...
            <main id="main" class="main">
                <div class="breadcrumb">
                    <ul class="breadcrumb-list">
                        ...
                        <li>&nbsp;&nbsp;&nbsp;마이페이지&nbsp;&nbsp;&nbsp;<i class="fas fa-angle-right"></i></li><li>&nbsp;&nbsp;&nbsp;문의내역</li>
                        </ul>
                        </div>
            <section>
           <div class="container">
