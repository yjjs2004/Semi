...
<script src="https://kit.fontawesome.com/034bf89b43.js"
...
<script
	src="${pageContext.request.contextPath}/js/lang/summernote-ko-KR.js"></script>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/summernote-lite.css">
<!--  -->
...
.cancelbtn, .submitbtn, #person_post, #person_addr, .person_addr_detail
	{
	float: left;
	width: 50%;
}
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css2/reset.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css2/layout.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css2/company/userInfo/myAccommodationLists.css">
<script>
	$(function() {
		...
		<div class="container2">
			<aside id="aside" class="aside">
				...
				<ul style="width: 230px;">
					<li class="active"><a
						href="${pageContext.request.contextPath}/update.com"><i
							class="far fa-user-circle"></i>&nbsp;&nbsp;회원정보수정</a></li>
					<li><a href="${pageContext.request.contextPath}/faqview.com"><i
							class="fa-solid fa-pen-to-square"></i>&nbsp;&nbsp;문의하기</a></li>
					<li><a href="${pageContext.request.contextPath}/faqinfo.com"><i
							class="fa-solid fa-chalkboard-user"></i>&nbsp;&nbsp;문의내역</a></li>
					<li><a href="${pageContext.request.contextPath}/faq.com"><i
			...
			<section>
				<form name="updateform" action="updateProcess.com" method="post">
					...
					<b>아이디</b> <input type="text" name="id" value="${personinfo.id }"
						readOnly><b>닉네임</b> <input type="text" name="nick"
						value="${personinfo.nickname }" readOnly> <b>비밀번호</b> <input
						type="password" name="pass" value="${personinfo.password }">
					<b>비밀번호 확인</b> <input type="password" name="passcheck"
						value="${personinfo.password }"> <b>휴대폰 번호</b> <input
						type="text" name="tel" value="${personinfo.tel }"> <b>이름</b>
					<input type="text" name="name" value="${personinfo.name }" readOnly>
					...
					<input type="button" onclick="sample6_execDaumPostcode()"
						...
						name="address" id="address" placeholder="주소"><br> <input
						type="text" name="detailAddress" id="detailAddress"
						placeholder="상세주소"> <input type="text"
						name="sample6_extraAddress" id="sample6_extraAddress"
						placeholder="참고항목"> <b>이메일 주소</b> <input type="text"
						name="email" id="email" value="${personinfo.email }"> <span
	...
	<section>
		<footer id="footer" class="footer">
			<div>
				...
				<p>
					<b>고객행복센터 1577-8282</b> 오전 09:00 ~ 오후18:00
				</p>

				<address>
					<span>(주)TEUM</span> 주소 : 서울특별시 종로구 인사동길 12 대일빌딩 15층 <br>대표이사
					: 신중언 | 사업자등록번호 777-11-45678 <br>통신판매번호 : 2020-서울강남-12345 |
					관광사업자 등록번호 : 제 1324-55호 <br>전화번호 : 010-1111-2222 <br>전자우편주소
					: teum@teum.co.kr <br>Copyright TEUM COMPANY Corp. All rights
					reserved.
				</address>
			</div>
		</footer>
